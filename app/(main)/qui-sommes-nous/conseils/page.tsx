    ...
    return (
      <div className='container mx-auto mt-20 px-4 py-16'>
        <div className='space-y-2 text-center mb-16'>
          <h1 className='text-4xl font-bold tracking-tighter text-primary sm:text-5xl'>Notre Blog</h1>
          <p className='mx-auto max-w-[700px] text-primary md:text-xl/relaxed'>Découvrez nos derniers articles</p>
        </div>
        <p>Chargement ...</p>
      </div>
    )
