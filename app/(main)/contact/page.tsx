    ...
    <div className='container mx-auto mt-20 px-4 py-12'>
      ...
      <div className='grid md:grid-cols-2 gap-12 max-w-6xl mx-auto'>
        ...
        <div className='space-y-8'>
          <h2 className='text-2xl text-primary font-semibold mb-6'>Nos Coordonnées</h2>

          <div className='space-y-6'>
            <div className='flex items-start space-x-4'>
              <MapPin className='w-6 h-6 text-secondary mt-1' />
              <div>
                <h3 className='text-primary font-medium mb-1'>Adresse</h3>
            ...
            <div className='flex items-start space-x-4'>
              ...
              <div>
                <h3 className='text-primary font-medium mb-1'>Téléphone</h3>
            ...
            <div className='flex items-start space-x-4'>
              ...
              <div>
                <h3 className='text-primary font-medium mb-1'>Horaires d&apos;ouverture</h3>
                <p className='text-muted-foreground'>
        ...
        <div className='bg-card p-8 rounded-lg shadow-sm'>
          <h2 className='text-2xl text-primary font-semibold mb-6'>Envoyez-nous un message</h2>
          <FormMessage />
        </div>
      </div>
    </div>
