    ...
    <div className='container mx-auto px-4 py-8 mt-28 space-y-16'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mt-16'>
          ...
          <Card>
            <CardContent className='pt-6'>
              ...
              <p className='text-muted-foreground'>partenaires majeurs du financement</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className='pt-6'>
      ...
      <section>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          <Card>
            ...
            <CardContent>
              <p className='text-muted-foreground'>Contactez-nous et signez votre convention de partenariat.</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <p className='text-muted-foreground'>Accédez à des opportunités rigoureusement sélectionnées.</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <p className='text-muted-foreground'>
                Profitez d&apos;un modèle de rémunération avantageux et récurrent.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
          ...
          <Card className='flex flex-col'>
            <CardHeader>
              <CardTitle className='text-2xl'>Rémunération des apporteurs d&apos;affaires</CardTitle>
            </CardHeader>
            <CardContent className='flex flex-col flex-grow'>
              <div className='flex-grow'>
                <h4 className='text-lg font-medium mb-3'>Montant levé & Rémunération</h4>
                <ul className='space-y-2 text-muted-foreground'>
                  <li className='flex items-center gap-2'>
                    <span>•</span>
