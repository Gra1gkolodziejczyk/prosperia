...
export const loginSchema = z.object({
  email: z
    ...
    .max(
      100,
      'Veuillez saisir une adresse email avec moins de 100 caractères.'
    ),
...
export const createBlogFormSchema = z.object({
  title: z
    .string()
    .min(1, 'Veuillez saisir un titre.')
...
export const createBlogSchema = z.object({
  ...
  mainImage: z
    .string()
    .url("Veuillez saisir une URL valide pour l'image principale."),
  creatorId: z
    .string({ required_error: "L'ID du créateur de l'invitation est requis." })
    .length(32)
    .regex(/^[A-Za-z0-9]+$/),
